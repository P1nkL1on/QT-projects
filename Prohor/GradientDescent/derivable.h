...
public:
    ...
    //friend Derivable Dcos(Derivable a);
    //friend Derivable Dsin(Derivable a);
    //friend Derivable Dpow(Derivable a, unsigned int power);

    //friend Derivable TanslateAndRotate (QVector<Derivable> original, QVector<Derivable> X);
